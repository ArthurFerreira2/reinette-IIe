...
// Added by Arthur Ferreira for reinette May 26th 2021

const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::AppleSoft()
{
	static bool inited = false;
	static LanguageDefinition langDef;
	if (!inited)
	{
		static const char* const keywords[] = {
			"AND", "OR", "NOT", "DIM", "NEW", "CLEAR", "LIST", "RUN", "LOAD", "SAVE",
      "IF", "GOTO", "ON", "FOR", "NEXT", "GOSUB", "RETURN", "POP", "ONERR",
      "RESUME", "STOP", "CONT", "END", "POKE", "CALL", "FREE", "GR", "COLOR",
      "PLOT", "HLIN", "VLIN", "HGR", "HGR2", "HCOLOR", "HPLOT", "TO", "DRAW",
      "XDRAW", "SCALE", "ROT", "IN#", "INPUT", "GET", "READ", "DATA", "RESTORE",
      "PR#", "PRINT", "?", "TEXT", "HOME", "HTAB", "VTAB", "INVERSE", "NORMAL", "FLASH"
		};
		...
		static const char* const identifiers[] = {
      "ABS", "SGN", "INT", "SQR", "SIN", "COS", "TAN", "ATN", "EXP", "LOG",
      "RND", "DEF", "FN", "LEN", "LEFT$", "MID$", "RIGHT$", "STR$", "CHR$",
      "VAL", "ASC", "PEEK", "USR", "HIMEM", "LOWMEM", "TRACE", "NOTRACE",
      "SCRN", "PDL", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""
		};
		for (auto& k : identifiers)
		{
